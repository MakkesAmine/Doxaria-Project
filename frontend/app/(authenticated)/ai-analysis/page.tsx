    ...
    setTimeout(() => {
      setAnalysisResult({
        ...
        medications: [
          ...
          { name: "Prednisone", dosage: "20mg" },
        ],
        warnings: [
          "Amoxicillin may cause allergic reactions or digestive issues. Use only as prescribed to avoid resistance",
          "Prednisone can suppress the immune system and elevate blood sugar. Gradual tapering is required to avoid adrenal issues"
        ],
        alternatives: [
          { 
            original: "Amoxicilline", 
        ...
        adherenceTips: [
          "Finish the entire prescribed course of **Amoxicillin**, even if you start feeling better, to fully clear the infection and prevent resistance.",
          "Do not stop **Prednisone** suddenly; always taper off gradually as prescribed to avoid withdrawal symptoms."
        ],
        progress: 100
      })
